...
import (
	...
	"github.com/paulgriffiths/goeval/automata/nfa"
	"testing"
)
...
func TestNfaToDfa1(t *testing.T) {
	...
	for _, tc := range testCases {
		if r := d.Accepts(tc.input); r != tc.result {
...
func TestNfaToDfa4(t *testing.T) {
	d := nfa.Nfa{
		4,
		sets.NewSetRune('a', 'b'),
		[]map[rune]sets.SetInt{
...
func TestNfaToDfa5(t *testing.T) {
	d := nfa.Nfa{
		4,
		sets.NewSetRune('0', '1'),
		[]map[rune]sets.SetInt{
...
func TestNfaToDfa6(t *testing.T) {
	d := nfa.Nfa{
		4,
		sets.NewSetRune('0', '1'),
		[]map[rune]sets.SetInt{
...
func TestNfaToDfa7(t *testing.T) {
	d := nfa.Nfa{
		6,
		sets.NewSetRune('0', '1'),
		[]map[rune]sets.SetInt{
...
func TestNfaToDfa8(t *testing.T) {
	d := nfa.Nfa{
		3,
		sets.NewSetRune('a', 'b'),
		[]map[rune]sets.SetInt{
